...
class WA_BAB {
    ...
    public function bab_general_scripts() {
        ...
        wp_register_script('bab-gooey', $this->plugin_url . 'assets/js/plugins/gooey.js', array(), $this->plugin_version, true);
	    	wp_register_script('bab-waves', $this->plugin_url . 'assets/js/plugins/waves.js', array(), $this->plugin_version, true);

        wp_enqueue_script( 'bab-front', $this->plugin_url . 'assets/js/main.js', array('bab-stars', 'bab-blurred-circles', 'bab-bubbles', 'bab-gooey', 'bab-waves'), $this->plugin_version, true );
    }
    ...
    public function bab_blocks_scripts() {
        $depends = array( 'wp-blocks', 'wp-i18n', 'jquery', 'bab-stars', 'bab-blurred-circles', 'bab-bubbles', 'bab-gooey', 'bab-waves' );
    ...
    public function bab_section_style_controls($objControls, $args){
        ...
        $objControls->add_control(
			...
			[
                ...
                'options'   => [
					...
					'bubbles-css' => esc_html__( 'Bubbles CSS', 'bab' ),
	    ...
	    // Bubbles CSS
	    $objControls->add_control(
		    'bab_bubbles_css_color',
		    [
			    'type'      => \Elementor\Controls_Manager::COLOR,
			    'label'     => esc_html__( 'Bubbles color', 'bab' ),
			    'condition'  => [
				    'bab_background_style' => 'bubbles-css',
			    ]
		    ]
	    );
    ...
    public function bab_enqueue_editor_scripts() {
        if ( \Elementor\Plugin::instance()->preview->is_preview_mode() ) {
            wp_enqueue_script('bab-admin-elementor', $this->plugin_url . 'assets/js/elementor-admin.js', array('jquery'), $this->plugin_version, true);
